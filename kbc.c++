...
void kbc::input()
{
    ...
    default:
        cout << "YOU ENTER A WRONG DIGIT AND YOU ARE NOT ABLE TO CONTINUE.\n"
             << endl
             << "*  TO PLAY THIS GAME PLEASE RUN ONCE AGAIN AND SELECT CORRECT OPTION THIS TIME.THANKYOU!  *" << endl;
    }
}
void kbc::intro()
{
        ...
        if (option == 4)
        {
            ...
            tick2:
                ...
                if (option == 3)
                {
                    ...
                    sum = sum + 10000;
                    cout << endl
                         << "*  congratulations you won Rs.10,000  **" << endl;
                s:
                    cout << "press 1 to continue the game or press any 0 to quit the game" << endl;
                    cin >> c;
                    if (c == '1')
                    {
                        system("cls");
